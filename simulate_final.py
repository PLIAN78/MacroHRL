...
plt.tight_layout()
plt.savefig('/home/ubuntu/research/figures/fig1_portfolio_values.png',
...
plt.tight_layout()
plt.savefig('/home/ubuntu/research/figures/fig2_drawdown.png',
            dpi=150, bbox_inches='tight')
plt.close()
...
with open('/home/ubuntu/research/data/results_final.json', 'w') as f:
