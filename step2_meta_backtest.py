...
vix=pd.read_csv('./data/vix.csv',index_col=0,parse_dates=True); vix.columns=['VIX']
...
quarterly_returns=np.load('./models/quarterly_returns.npy')
macro_feat=np.load('./models/macro_feat.npy')
