...
vix_df  = pd.read_csv('/home/ubuntu/research/data/vix.csv', index_col=0, parse_dates=True)
vix_df.columns = ['VIX']
...
for idx, name in regime_map.items():
    for path in [f'/home/ubuntu/research/models/sub_{name}.zip',
                 f'/home/ubuntu/research/models/sub_{idx}_ppo.zip']:
...
cache_path = '/home/ubuntu/research/data/sub_returns_2020_2022.npy'
cache_meta_path = '/home/ubuntu/research/data/sub_returns_meta_2020_2022.json'
...
for qi, q in enumerate(train_quarters):
    ...
    for regime_idx in range(4):
        ...
        blended = 0.5 * (raw_ret_q * 10) + 0.5 * sharpe_q
...
meta_model.save('/home/ubuntu/research/models/meta_e2e_v2.zip')
...
with open('/home/ubuntu/research/data/results_e2e_v2.json','w') as f:
    json.dump(results, f, indent=2)
with open('/home/ubuntu/research/data/regime_dist_e2e_v2.json','w') as f:
